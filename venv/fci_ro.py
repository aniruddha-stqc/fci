...
class Fci(unittest.TestCase):
    ...
    def test_fci(self):
        ...
        # Invoke Firefox
        driver = webdriver.Firefox(options=options, executable_path="./geckodriver", service_log_path=os.devnull)
        driver.get("https://fcidepotonline.gov.in/loginpage")
        ...
        driver.find_element_by_xpath("//span[@id='logout']/b").click()
